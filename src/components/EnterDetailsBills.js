...
const EnterDetailsBills = (props) => {
    return (
      <>
               ...
               <div className="bills-col">
               <Link to="/bills"> <div style={{fontSize:'13px',display:'inline-block',borderBottom:'2px solid #DE7949'}}>Back</div></Link>  
                 </div>
              ...
              <div className="bills-form-block">
               ...
               <input className="bills-input" style={{ width:"100%"}} type="text" placeholder="Type here"/>
               </div>
               ...
               <div className="bills-info-label">Amount</div>
               <input className="bills-input-2" style={{ width:"100%"}} type="text" placeholder="Type here"/>
               </div>
               <p
